...
describe('Integration with Mingo', function () {
    describe.only('like', function () {
        it('$regex', function () {
            let query = new mingo.Query({title: {$regex: /Post/i}});
            console.log(query.test(advancedJSON.posts[0]));
            console.log(query.test(advancedJSON.posts[1]));
            console.log(query.test(advancedJSON.posts[2]));
            console.log(query.test(advancedJSON.posts[3]));
            console.log(query.test(advancedJSON.posts[4]));
        });

        it('$not', function () {
            let query = new mingo.Query({title: {$not: {$regex: /Post/i}}});
            console.log(query.test(advancedJSON.posts[0]));
            console.log(query.test(advancedJSON.posts[1]));
            console.log(query.test(advancedJSON.posts[2]));
            console.log(query.test(advancedJSON.posts[3]));
